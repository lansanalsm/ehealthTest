<html>
	...
	<body>
	 ...
	 function tree($val, $sons)
		{
			$new_son = array ('value' => $val,'sons' => $sons);
			return  $new_son ; 
		}
      
     //building the tree shown in the pdf file
	...
	//example of a depth first search algorithm
    //This function lets us know the length of the tree
	
	function length($tree)
		{
			$count = 1;
			foreach($tree['sons'] as $sons)
				$count += length($sons);
			return $count;
		}
	...
	echo" the size of the tree is : $result <br/> ";
